                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <a href="../../pages/admin/docsEdit.php?edit=<?php echo $row['Id']; ?>" class="btn btn-info"><span class="mdi mdi-border-color"></span></a>
                                <a href="../../pages/admin/docslist.php?delete=<?php echo $row['Id']; ?>" class="btn btn-danger"><span class="mdi mdi-delete-forever"></span></a>
                                <a href="../../pages/admin/view.php?view=<?php echo $row['Id']; ?>" target="blank" class="btn btn-success"><span class="mdi mdi-book-open-variant"></span></a>
                              </td>
                            </tr>
