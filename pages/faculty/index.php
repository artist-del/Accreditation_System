          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-xl-6 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">RSU Faculty</h6>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"><?php echo $q_count?></h3>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Romblon State University Cajidiocan Campus</h4>
                      <img src="images/images.jpeg" alt="RSU" height="300px" width="100%" style="border-radius: 20px;">
                  </div>
                </div>
              </div>
